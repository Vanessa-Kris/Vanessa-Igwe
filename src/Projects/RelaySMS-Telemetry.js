            ...
            <Box id="overview" sx={{ my: 10 }}>
              ...
              <Grid container spacing={4}>
                <Grid item xs={12} md={12}>
                  ...
                  >
                    The RelaySMS Telemetry Dashboard is a comprehensive
                    analytics platform that provides real-time insights into
                    user activity, message delivery performance, and service
                  ...
                  >
                    ...
                    identify bottlenecks, and make data-driven decisions to
            ...
            >
              ...
              <Grid container spacing={4}>
                <Grid item xs={12} md={8}>
                  ...
                  >
                    The previous dashboard suffered from poor information
                    hierarchy, making it difficult to quickly identify critical
                    metrics.
                  </Typography>
                  <Box component="ul" sx={{ mb: 0 }}>
                    ...
                    >
                      • Visualization methods didn't effectively communicate
                    ...
                    >
                      • No clear way to identify user geographic distribution
                    ...
                    >
                      • Team spent excessive time manually analyzing data to
                      extract insights
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      How can we transform complex telemetry data into
                      actionable insights that help the team respond quickly to
                      system issues and user needs?
                    </Typography>
                  </Box>
                </Grid>
              </Grid>
            ...
            >
              ...
              <Box sx={{ mb: 5 }}>
                ...
                <Box sx={{ pl: { md: 8 } }}>
                  ...
                  >
                    • Conducted in-house interviews with the development team
                    and product manager
                  </Typography>
                  <Typography
                    variant="h5"
                  ...
                  >
                    • Analyzed and identified pain points in the existing
                    dashboard
                  </Typography>
                  <Typography
                    variant="h5"
                  ...
                  >
                    • Researched industry-standard dashboard designs and best
                    practices
                  </Typography>
                  <Typography
                    variant="h5"
              ...
              <Box sx={{ mb: 5 }}>
                ...
                <Box sx={{ pl: { md: 8 } }}>
                  ...
                  >
                    ...
                    quickly, so I skipped the wireframing and built immediately.
                    We already had a template idea.
                  </Typography>
                  <Typography
                    variant="h5"
                    sx={{
                  ...
                  >
                    • Prioritized metrics using the "above the fold" principle
                    for critical data counts and trends
                  </Typography>
                  <Typography
                    variant="h5"
                    sx={{
                  ...
                  >
                    • Designed card-based layouts for scannability and
                    modularity
                  </Typography>
                </Box>
              </Box>
                  ...
                  >
                    ...
                    <Box sx={{ pl: { md: 2 }, color: colors.textTertiary }}>
                      ...
                      <Typography
                        ...
                        sx={{ fontSize: "18px", lineHeight: 1.8, mb: 1 }}
                      >
                        • <strong>Average Delivery Time:</strong> Time taken
                      ...
                      <Typography
                        ...
                        sx={{ fontSize: "18px", lineHeight: 1.8 }}
                      >
                        • <strong>Platforms:</strong> Which platforms users
                        publish messages to.
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  >
                    ...
                    <Box sx={{ pl: { md: 2 }, color: colors.textTertiary }}>
                      <Typography
                        ...
                        sx={{ fontSize: "18px", lineHeight: 1.8, mb: 1 }}
                      >
                        • <strong>Geographic Heat Map:</strong> Visual
                        representation of usage by region
                      </Typography>
                      <Typography
                        variant="h5"
                        sx={{ fontSize: "18px", lineHeight: 1.8, mb: 1 }}
                      >
                        • <strong>Regional Performance:</strong> Delivery rates
                        per country/region
                      </Typography>
                      <Typography
                        variant="h5"
                        sx={{ fontSize: "18px", lineHeight: 1.8 }}
                      >
                        • <strong>Network Carrier Data:</strong> Performance
                        breakdown by mobile carriers
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
            ...
            <Box sx={{ mb: 10 }}>
              ...
              <Box sx={{ mt: 3, pl: { md: 3 } }}>
                ...
                <Typography
                  ...
                  sx={{ fontSize: "18px", lineHeight: 1.8, mb: 1 }}
                >
                  <strong>State Management:</strong> React Context API for
                  global state
                </Typography>
                <Typography
                  variant="h5"
            ...
            <Box sx={{ mb: 10 }}>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                >
                  ...
                  information quickly and enable future customization features
                  where users can rearrange or hide specific metrics based on
                  their needs.
                </Typography>
              </Box>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                >
                  Implemented a consistent color system to allow instant
                  recognition of system health without reading detailed metrics.
                </Typography>
              </Box>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                >
                  Added customizable date ranges (24 hours, 7 days, 30 days,
                  custom) to let users analyze data at different granularities,
                  from real-time monitoring to long-term trend analysis.
                </Typography>
              </Box>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  >
                    ...
                    >
                      ...
                      available metrics, careful curation based on user needs
                      leads to better outcomes. Also, there's a whole lot that
                      could be done with chaotic data; it gives room for more
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <Box sx={{ display: "flex", mb: 3 }}>
                      ...
                      >
                        Admin dashboard for in-house team to manage user data,
                        SMS cost breakdown, analysis, and predictions based on
                        trends and data
                      </Typography>
                    </Box>
                    <Box sx={{ display: "flex", mb: 3 }}>
